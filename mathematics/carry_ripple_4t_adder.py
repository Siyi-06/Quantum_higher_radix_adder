...
class CarryRipple4TAdder():
    ...
    def __init__(self, nr_qubits = 3, use_dual_ancilla = False):
        ...
        self.qubits_c0 = cirq.NamedQubit("c0" )
        ...
        #self.qubits_c_last = cirq.NamedQubit("c_last" )

        self._qubit_order.append(self.qubits_c0)
        ...
        #self._qubit_order.append(self.qubits_c_last)
    ...
    def construct_circuit(self, nr_qubits):
        ...
        for ripple_i in range(nr_qubits - 1):
            ...
            #cnot_control_qubit.insert(0, self.qubits_c0)

            # if self.use_dual_ancilla:
            #     if ripple_i != 0:
            #         cnot_control_qubit = self.qubits_d[carry_in_idx]
            if ripple_i == 0:
                self.circuit.append(cirq.CNOT.on(self.qubits_c0,

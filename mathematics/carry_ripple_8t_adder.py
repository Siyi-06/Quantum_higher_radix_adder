...
class CarryRipple8TAdder():
    ...
    def __init__(self, nr_qubits = 3, use_dual_ancilla = False,UMA_2_CNots=False):
        ...
        if UMA_2_CNots:
            self.construct_circuit_2cnot(nr_qubits)
        else:
            self.construct_circuit_3cnot(nr_qubits)
    ...
    def construct_circuit_3cnot(self, nr_qubits):
    ...
    def construct_circuit_2cnot(self, nr_qubits):
        self.circuit = cirq.Circuit()

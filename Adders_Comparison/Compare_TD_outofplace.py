...
def Our_Adder_Method3(n,r):
    TD =6*(math.floor(math.log2(math.ceil(n/r)-1))+math.floor(math.log2(1/3*(math.ceil(n/r)-1)))+4)+6*math.floor(math.log2(r-2)+1)+9*r-10
    # #remove BK-1
    # TD=TD-3*(math.floor(math.log2(math.ceil(n/r)-1))+math.floor(math.log2(1/3*(math.ceil(n/r)-1)))+1)
    # #remove higer radix-1
    # TD=TD-(r-2)*3-3*math.floor(math.log2(r-2)+1)-3
    # #remove Gidney-1
    # TD=TD-(r-1)*3
    print(TD)
def Our_Adder_Gidney_Method3(n,r):
    TD = 6 * (math.floor(math.log2(math.ceil(n / r) - 1)) + math.floor(math.log2(1 / 3 * (math.ceil(n / r) - 1))) + 4) + 6 * math.floor(math.log2(r - 2) + 1) + 7* r - 7
    # TD=TD-3*(math.floor(math.log2(math.ceil(n/r)-1))+math.floor(math.log2(1/3*(math.ceil(n/r)-1)))+1)
    # TD=TD-(r-2)*3-3*math.floor(math.log2(r-2)+1)-3
    print(TD)
